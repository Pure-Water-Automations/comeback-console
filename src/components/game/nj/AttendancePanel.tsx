...
import { Activity, CalendarDays, SignalHigh, TrendingDown, Trophy } from "lucide-react";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 20%, rgba(45,212,191,0.17), transparent 35%)",
        }}
      />
          ...
          >
            ...
            <div className="h-[390px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={weeklyData} margin={{ top: 24, right: 24, bottom: 8, left: 0 }}>
                  <defs>
          ...
          <div className="grid gap-5">
            ...
            >
              ...
              <div className="h-[250px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={ATTENDANCE_2026} margin={{ top: 10, right: 10, bottom: 0, left: 0 }}>
                    <CartesianGrid stroke="#ffffff14" strokeDasharray="3 3" />
                    <XAxis
                      dataKey="month"
                      tick={{ fill: "rgba(255,255,255,0.52)", fontSize: 11 }}
                    ...
                    />
                    <Bar dataKey="sundayInPerson" name="In person" stackId="sunday" fill="var(--chart-2)" />
                    <Bar dataKey="sundayOnline" name="Online" stackId="sunday" fill="var(--chart-1)" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="border border-signal/30 bg-signal/10 p-4 shadow-[0_0_18px_rgba(239,68,68,0.16)]">
                ...
                <p className="mt-3 text-sm leading-6 text-white/68">
                  Other-event attendance dropped sharply since February. That is a clear follow-up
                  and calendar-planning signal.
                </p>
              </div>
              <div className="mt-4 h-[190px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={ATTENDANCE_2026} margin={{ top: 10, right: 12, bottom: 0, left: 0 }}>
                    <CartesianGrid stroke="#ffffff14" strokeDasharray="3 3" />
                    <XAxis
                      dataKey="month"
                      tick={{ fill: "rgba(255,255,255,0.52)", fontSize: 11 }}
                    ...
                    <Line
                      ...
                      activeDot={{ r: 7, stroke: "#fff", strokeWidth: 1, fill: "var(--chart-5)" }}
                    />
                  </LineChart>
                </ResponsiveContainer>
              </div>
